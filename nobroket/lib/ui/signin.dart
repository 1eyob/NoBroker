...
var header =  json.encode(params);
String name,phone,address;
var image;
 
final response = await http.get(URL_LOGIN,headers:{"Content-Type":"application/json","password":password,"email":email});
    ...
    var id = res['_id'];
    var image = await http.get("http://$SERVER_NAME:3000/api/users/$id/image");
        var response_item;
    var res_item;
    ...
    response_item = await http.get(URL_ITEMS);
    res_item = json.decode(response_item.body);
     print(res_item);
  
   
     print(image);
    User user = User(res['name'],res['email'],res['password'],res['address'],res['phone'],image.bodyBytes);
